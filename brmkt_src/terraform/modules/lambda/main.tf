...
# Lambda URIs are "{+lambda}/{+function}" e.g. "brmkt/ping".
# We also support path matching at the root e.g. "brmkt" but these require definining separate "_root" terraform resources.
