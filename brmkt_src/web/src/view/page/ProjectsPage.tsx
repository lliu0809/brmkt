    ...
    <>
      ...
      <BodyText>
        <ul className="pl4">
          ...
          <li>
            Must use the class project framework located <Link href="https://github.com/rothfels/brmkt">here</Link>
          </li>
            ...
            checklistFull={[
              {
                ...
                href: 'https://github.com/rothfels/brmkt#quickstart',
              },
              {
              ...
              },
              {
                ...
                href: 'https://github.com/rothfels/brmkt#run-react-storybook',
              },
            ]}
          />
          <Sprint
